...
function buildSearchQuery(params) {
    ...
    if (params.destination && params.destination.branch && params.destination.branch.name) {
        if (queryString) {
            queryString += ' AND destination.branch.name="' + params.destination.branch.name + '"';
        } else {
            queryString += 'destination.branch.name="' + params.destination.branch.name + '"';
        }
    }
