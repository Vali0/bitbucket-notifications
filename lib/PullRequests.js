...
function serializePullRequestsData(pullRequests, pullRequestsList) {
    let result = Object.assign({}, pullRequestsList); // Cloning target object so we don't change it by reference
